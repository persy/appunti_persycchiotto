...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Struttura_della_cellula_animale.svg/700px-Struttura_della_cellula_animale.svg.png" title="Schema di una cellula animale" >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/Celltypes.svg/640px-Celltypes.svg.png" title="Differenze fondamentali tra cellula eucariote e procariote" >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/27/Cell_membrane_detailed_diagram_4_it.svg/511px-Cell_membrane_detailed_diagram_4_it.svg.png" title="Il modello a mosaico fluido della membrana plasmatica" >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/it/f/f0/Schema_nucleo_cellulare.jpg" title="Schema del nucleo cellulare e del reticolo endoplasmatico annesso" >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f6/Nucleus_ER_golgi.svg/492px-Nucleus_ER_golgi.svg.png" title="Schema del percorso secretorio tra nucleo, reticolo endoplasmatico e apparato del Golgi: 1. Membrana nucleare; 2. Poro nucleare; 3. Reticolo endoplasmatico rugoso (RER); 4. Reticolo endoplasmatico liscio (REL); 5. Ribosoma legato al RER; 6. Macromolecole; 7. Vescicole di trasporto; 8. Apparato di Golgi; 9. Faccia Cis dell'apparato di Golgi; 10. Faccia Trans dell'apparato di Golgi; 11. Cisterne del Golgi." >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/39/Mitochondrie.svg/320px-Mitochondrie.svg.png" title="Schema di un mitocondrio: 1. membrana interna, 2. membrana esterna, 3. cresta, 4 matrice" >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Bronchiolar_epithelium_4_-_SEM.jpg/585px-Bronchiolar_epithelium_4_-_SEM.jpg" title="Ciglia dell'epitelio di un polmone (microscopio a scansione)" >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d1/Struttura_della_cellula_vegetale.svg/700px-Struttura_della_cellula_vegetale.svg.png" title="Struttura della cellula vegetale" >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/4/49/Plagiomnium_affine_laminazellen.jpeg" title="Cellule vegetali al cui interno sono visibili i cloroplasti" >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/06/Figure_04_02_02.jpg/800px-Figure_04_02_02.jpg" title="Dall'atomo all'organismo" >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/8/86/TrasportoMembrana.png" title="Alcune delle possibilità di movimento di molecole tra citoplasma (1) e spazio extracellulare (2). Trasporto passivo: A. Diffusione; B. Diffusione facilitata; Trasporto attivo:" >}}
...
_6CO<sub>2</sub> + 6H<sub>2</sub>O ⟶  C<sub>6</sub>H<sub>12</sub>O<sub>6</sub> + 6O<sub>2</sub>" >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c5/Reazioni_luce-dipendenti.png/800px-Reazioni_luce-dipendenti.png" title="Le reazioni della fase luce dipendente della fotosintesi clorofilliana." >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/f/f9/HatchSlackpathway.png" title="Schema riassuntivo delle reazioni della fase luminosa e della fase oscura della fotosintesi" >}}
...
_C<sub>6</sub>H<sub>12</sub>O<sub>6</sub> + 2ATP ⟶ 2CH<sub>3</sub>COCOOH + 4ATP + 2NADH" >}}
...
{{< figure src="https://odobiochem.files.wordpress.com/2016/03/ciclo-di-krebs-nel-contesto-della-respirazione-cellulare-aerobica.jpg?w=760" title="Schema della respirazione cellulare" >}}
...
3. Il **NADH** e il **FADH<sub>2</sub>** **entrano nella catena di trasporto degli elettroni**, costituita da una serie di proteine (**citocromi**), ordinate sulle creste dei mitocondri. Gli elettroni degli
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/78/Ciclo_di_Krebs.svg/719px-Ciclo_di_Krebs.svg.png" title="Schema del Ciclo di Krebs" >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Nucleotides_1-it.svg/800px-Nucleotides_1-it.svg.png" title="Elementi costituitivi dei nucleotidi" >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f5/DNA_Overview_it.png/239px-DNA_Overview_it.png" title="Struttura a doppia elica del DNA" >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f7/DNA_chemical_structure_it.svg/514px-DNA_chemical_structure_it.svg.png" title="Struttura chimica del DNA. Le sequenze possono essere definite senso e non senso." >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/f/fb/MRNA-interaction.png" title="Il \"ciclo vitale\" di un mRNA in una cellula eucariote. L'RNA è trascritto nel nucleo cellulare; dopo essere stato completamente modificato viene trasportato nel citoplasma e tradotto da un ribosoma. Alla fine della sua vita l'mRNA viene degradato." >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d6/GeneticCode21-version-2.svg/791px-GeneticCode21-version-2.svg.png" title="Tabella codifica codoni nel DNA" >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/Ribosome_mRNA_translation_it.svg/651px-Ribosome_mRNA_translation_it.svg.png" title="Rappresentazione della traduzione e sintesi proteica nel ribosoma" >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ae/DNA_replication_it.svg/640px-DNA_replication_it.svg.png" title="La replicazione del DNA" >}}
...
{{< figure src="https://mattiasegu.files.wordpress.com/2013/03/mitosi-meiosi.jpg" title="Fasi della mitosi e della meiosi" >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/9/91/Anaphase_IF.jpg" title="Cellula in anafase" >}}
